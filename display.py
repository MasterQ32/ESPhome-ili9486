...
ILI9486ColorMode = ili9486_ns.enum("ILI9486ColorMode")
...
COLOR_PALETTE = cv.one_of("NONE", "GRAYSCALE", "IMAGE_ADAPTIVE", "BITS_16")
...
async def to_code(config):
    ...
    if config[CONF_COLOR_PALETTE] == "GRAYSCALE":
        cg.add(var.set_buffer_color_mode(ILI9486ColorMode.BITS_8_INDEXED))
        rhs = []
        for x in range(256):
        ...
        cg.add(var.set_buffer_color_mode(ILI9486ColorMode.BITS_16))
